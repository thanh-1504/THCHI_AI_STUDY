...
/* ─────────────────────────────────────────────
   Forgot-password modal (inline, admin context)
───────────────────────────────────────────── */
const AdminForgotModal = ({ onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    // TODO: gọi API gửi OTP reset mật khẩu admin
  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-[61] pointer-events-none">
        <div
          className="pointer-events-auto relative rounded-2xl px-8 pt-10 pb-8 flex flex-col gap-5 min-w-[360px] max-w-md"
          style={{
            background:
              "linear-gradient(135deg, rgba(30,34,54,0.98) 0%, rgba(18,22,38,0.98) 100%)",
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 w-8 h-8 flex items-center justify-center rounded-full cursor-pointer transition-all duration-150"
          ...
          {!sent ? (
            <>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoFocus
                  className="w-full pl-9 pr-4 py-3 rounded-xl text-white text-sm outline-none transition-all duration-200"
                  style={{
                    background: "rgba(255,255,255,0.06)",
                    border: "1px solid rgba(255,255,255,0.12)",
                  }}
                  onFocus={(e) => {
                    e.target.style.borderColor = "rgba(88,204,2,0.7)";
                    e.target.style.boxShadow = "0 0 0 3px rgba(88,204,2,0.12)";
                  }}
                  onBlur={(e) => {
            ...
            <div className="flex flex-col items-center gap-4 py-2">
              ...
              <p className="text-gray-300 text-sm text-center leading-relaxed">
                ...
                <span className="font-semibold" style={{ color: "#58cc02" }}>
                  {email}
                </span>
                .
                <br />
              ...
              <button
                onClick={onClose}
                className="px-6 py-2 rounded-xl text-sm font-bold text-white transition-all duration-200 cursor-pointer"
                style={{
                  background:
                    "linear-gradient(83deg, #58cc02 9.02%, #23ac38 90.81%)",
...
const AdminLogin = () => {
  ...
  return (
    <>
      ...
      {showForgot && <AdminForgotModal onClose={() => setShowForgot(false)} />}
    </>
  );
};
