      ...
      <div className="flex items-center gap-x-3">
        <div className="border-2 border-yellow-400 rounded-full p-[2px]">
          <img
            ...
            src="https://images.unsplash.com/photo-1609505848912-b7c3b8b4beda?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2lybHxlbnwwfHwwfHx8MA%3D%3D"
            alt="avatar"
          />
        </div>
        <div>
